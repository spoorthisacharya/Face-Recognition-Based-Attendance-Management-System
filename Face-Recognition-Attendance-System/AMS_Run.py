    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/spoor/Face-Recognition-Attendance-System/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                     r'explorer /select,"C:\Users\spoor\Face-Recognition-Attendance-System\Attendance\Manually Attendance\-------Check atttendance-------"')
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = "C:/Users/spoor/Face-Recognition-Attendance-System" + fileName
    ...
    def log_in():
        ...
        if username == 'spoorthi':
            if password == 'spoo123':
                ...
                cs = 'C:/Users/spoor/Face-Recognition-Attendance-System/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
